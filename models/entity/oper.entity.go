...
type Operate struct {
	...
	BusinessType  int        `gorm:"column:business_type;default:4;comment:业务类型(1新增 2修改 3删除 4其它)" json:"businessType"`
	...
	OperatorType  int        `gorm:"column:operator_type;default:3;comment:操作类别(1后台用户 2手机端用户 3其它)" json:"operatorType"`
	...
	Status        int        `gorm:"column:status;comment:操作状态(1正常 2异常)" json:"status"`
}
