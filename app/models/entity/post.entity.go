...
type Post struct {
	...
	Status     int        `gorm:"column:status;default:1;comment:岗位状态（1正常 2停用）" json:"status"`
...
func (p *Post) To() (map[string]any, error) {
	//TODO implement me
	panic("implement me")
}

func (p *Post) Fields() (fields []*utils.ExcelField, err error) {
	//TODO implement me
	panic("implement me")
}
